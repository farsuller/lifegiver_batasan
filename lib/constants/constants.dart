...
var hotLinearStart = Color(0xffFFB157);
var hotLinearEnd = Color(0xffFFA057);
var blushStart = Color(0xffFF5B95);
var blushEnd = Color(0xffF8556D);
...
var dashboardDataItems = [
  ReportCard('Did you attend your', 'Life group?',"assets/images/yp-women.png",
      hotLinearStart, hotLinearEnd,hotLinearStart, hotLinearEnd),
  ReportCard('Did you attend', 'Sunday Service?',"assets/images/men.png",
      blushStart, blushEnd,blushStart, blushEnd),
  ReportCard('Did you attend a', 'Sate life?',"assets/images/yp-men.png",
      cosmicFusionStart, cosmicFusionEnd,cosmicFusionStart, cosmicFusionEnd),
  ReportCard('Did you Book for', 'Fellow ship?',"assets/images/book-sunday.png",
      earthlyStart, earthlyEnd,quepalStart, quepalEnd),
