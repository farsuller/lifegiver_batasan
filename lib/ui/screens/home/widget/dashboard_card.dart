...
class DashboardCard extends StatelessWidget {
  ...
  final bool toAdjust;
  const DashboardCard({
    Key key, this.header, this.text, this.image, this.startColor, this.endColor,this.toAdjust, this.buttonStartColor, this.buttonEndColor
  }) : super(key: key);
                ...
                Stack(
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(left:8.0,bottom: toAdjust? 25.0 : 5.0),
                        child: Container(
                          width: 150,
                          child: Text(text,
                              style:TextStyle(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: GestureDetector(
                          onTap: ()=>Get.toNamed("/sunday_service_profile"),
                          child: Center(
                            child: Text('YES',
